                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            echo $this->Form->create('Career', array('enctype' => 'multipart/form-data', 'role' => 'form', 'url' => array('controller' => 'careers', 'action' => 'add')));
                            ?>
                            <!--                                <form role="form">-->
                            ...
                            <?php //echo $this->Form->input('image_name', array('type' => 'file', 'id' => 'exampleInputFile', 'label' => false)); ?>
                                                        </div>         -->
