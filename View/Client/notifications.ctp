            ...
            <div class="bg_white notifications">
                ...
                <div class="col-md-12 marg_tb15">
                    ...
                    <div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['0']) && $check['0'] == 'yes') {
                ...
                echo 'value=no';
                    ...
                    <p class="pull-left" >A job is posted or modified. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['1']) && $check['1'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left" >A job  application is received. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['2']) && $check['2'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">An interview is accepted or offer terms are modified.</p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['3']) && $check['3'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">A interview or offer is declined or withdrawn. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['4']) && $check['4'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">An offer is accepted. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['5']) && $check['5'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left" >A job posting will expire soon. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['6']) && $check['6'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">A job posting expired. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['7']) && $check['7'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">No interviews have been initiated. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['8']) && $check['8'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                ...
                <div class="col-md-12 marg_tb15">
                    ...
                    <p class="pull-left" >A job is posted or submitted. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['9']) && $check['9'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left" >An interview is initiated. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['10']) && $check['10'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">An offer or interview invitaion is recieved.</p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['11']) && $check['11'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">A  offer  or interview invitaion is withdrawn. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['12']) && $check['12'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">A job application is rejected. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['13']) && $check['13'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left" >A job I applied to is modified or canceled. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['14']) && $check['14'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                ...
                <div class="col-md-12 marg_tb15">
                    ...
                    <p class="pull-left" >A hire is made or a contract begins . </p>
                    <div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['15']) && $check['15'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">A job is received. </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['16']) && $check['16'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left" >Time logging begins .</p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['17']) && $check['17'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">Contract terms are modified . </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['18']) && $check['18'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left" >A contract ends. </p><div class="checkbox pull-right " id='chekdata' >
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['19']) && $check['19'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left" >A timelog is ready for review . </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['20']) && $check['20'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">Feedback changes are made  . </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['21']) && $check['21'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
...
<!--<input type='hidden' name="check_value[]" id='chek' value='yes'>-->
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['22']) && $check['22'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <p class="pull-left">Weekly billing digest . </p><div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['23']) && $check['23'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                    ...
                    <div class="checkbox pull-right">
                        <input type="checkbox" id='chek' name="check_value[]"    class='chkdata' <?php if (isset($check['24']) && $check['24'] == 'yes') {
                echo "value='yes' checked='checked'";
            } else {
                echo 'value=no';
            } ?>>
                ...
                <div class="img_loader  loader hide ">
                    <img src="<?php echo $this->webroot; ?>img/loading_blue.gif" alt="image">
                </div>
