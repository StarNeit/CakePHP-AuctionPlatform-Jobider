...
<div class="modal-dialog" id="datapay">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <?php echo $this->Form->create('Creditpayment', array('class' => 'apply_jobform withdraw_earnings p15 font_14 form-horizontal datacredit hide', 'role' => 'form', 'url' => array('controller' => 'client', 'action' => 'card_payment'))); ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <input type="hidden" name="data[Creditpayment][amount]" value="<?php echo $pay ?>">
                    <input type="hidden" name="data[Creditpayment][payment_type]" value="<?php echo $type; ?>">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="radio_payment paypalval">
                    <label class="checkbox-inline">
                        <input type="radio" id="inlineCheckbox1" value="option1" class="paypal" >                          <img src="<?php echo $this->webroot; ?>img/imgo.jpeg" alt="image">
                    </label>

                </div>
                <div class="radio_payment creditdata">
                    <label class="checkbox-inline">
                        <input type="radio" id="inlineCheckbox1" value="option1" class="credit"> <img src="<?php echo $this->webroot; ?>img/imgo2.jpeg" style="" alt="image">
                    </label>
            ...
            <div class="bg_grey  marg_30 datapayment hide">
                ...
                <div class="col-md-3 col-sm-2 set_up text-center">
                    ...
                    <input type="hidden" name="data[Paypalpayment][payment_amount]" value="<?php echo $pay; ?>">
                    <input type="hidden" name="data[Paypalpayment][payment_type]" value="<?php echo $type; ?>">
                    <button class="btn btn-danger col-md-12 marg_tb15" type="submit" name="pay" value="pay">Pay Now </button>
