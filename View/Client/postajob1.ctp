        ...
        <div class="col-md-3 pad_l0 col-sm-3">
            ...
            <div class="panel panel-default green_bg1">
                ...
                <div class="panel-body bg_grey1 padd_tb15">
                    ...
                    <p><i><img src="<?php echo $this->webroot; ?>img/view.png" class="mrg_r5" alt="See all"/></i><a href="#">See all notifications  >></a></p>
            ...
            <!--<select class="form-control"><option></option><option>option1</option><option>option1</option></select>-->
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="fileUpload btn btn-primary pull-right">
                        <span>Browse</span>
                        <?php echo $this->Form->input('image_name', array('type' => 'file', 'id' => 'exampleInputFile', 'class' => 'upload', 'label' => false)); ?>
                    </div>
                </div>
                <div class="clearfix"></div>
