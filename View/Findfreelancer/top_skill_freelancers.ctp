<div class="container">
    <div class="title">
        <?php if (isset($SkillName) and !empty($SkillName)) { ?>
            <h2><span class=" text-left"><?php echo ucfirst($SkillName['Skill']['name']) . '  ' . '  Developers & Programmers'; ?></span>
    ...
    <div class="col-md-7 col-md-offset-3">
        <?php echo $this->Form->create('User', array('url' => array('controller' => 'findfreelancer', 'action' => 'TopSkillFreelancers/' . $id))); ?>
            ...
            foreach ($Freelancer_user as $key => $val) {
                ...
                <div class="col-md-12 skill_sec">
                    <div class="col-sm-3 col-md-2 text-center immg_sec">
                        ...
                        <?php } else { ?>
                            <img src="<?php echo $this->webroot; ?>img/freelancer.png" alt="dummy user image" class="img-thumbnail"/>
                        <?php } ?>
                    </div>
                    <div class="col-sm-6 col-md-8 middle_dv">
                        ...
                        <div  class="moreval hide">
                            <p>
                                <?php echo $val['User']['description']; ?>
                                <a href="JavaScript:void(0);" class="less" style="font-size: 15px; text-decoration: none;">less</a>
                            </p>
                        </div>

                        <h3><img alt="location image icon" src="<?php echo $this->webroot; ?>img/location1.png"><b> <?php echo $val['User']['Country_name']['Country']['name']; ?></b>&nbsp; -&nbsp; Last days&nbsp;:&nbsp; <?php
                            if (!empty($val['User']['test_timeduration'])) {
