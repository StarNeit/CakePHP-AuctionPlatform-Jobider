...
<!--        <a type="Button" class="btn btn-sm  btn_red btn_red12 pull-right" <button="" href="/developer/freelancer/postajob">Post a job</a>-->
    ...
    <div class="row">
                ...
                <form class="cust_form sider_bar_form">
                    ...
                    <div class="web_job">
                        <ul class="list-group padd_tb15">
                            ...
                            <li class="list-group-item active"> <a href="<?php   echo $this->webroot;?>findfreelancer/category_jobs/<?php echo $Category['Category']['id'];?>" style="text-decoration: none"><?php echo $Category['Category']['name']; ?></a></li>
                        </ul>
                    </div>
        ...
        <div class="col-md-8 col-sm-8 marg_btm30">
            ...
            <div class="clearfix"></div>
            <?php if (!empty($jobdata) and isset($jobdata)) {
                foreach ($jobdata as $key => $val) {
                    ?>
                    <div class="bg_white freelaners marg_btm30">
                        <div class="green">
                            <a style="color:white; text-decoration: none" href="<?php echo $this->webroot; ?>findfreelancer/jobsdata/<?php echo $val['Job']['id']; ?>">
        <?php echo $val['Job']['job_title']; ?></a>
                        ...
                        <div class="bg_grey1 pull-left marg_t5">
                            <div class="location pull-right">
                                <i><img alt="Estimated Budget image icon" src="<?php echo $this->webroot; ?>img/project_img.png"></i><span class=" text_green">Est. Budget:<?php echo '$'.$val['Job']['budget']; ?></span>
                            </div>
                            <div class="location pull-right">
                                <i><img  src="<?php echo $this->webroot; ?>img/clock.png" alt="Clock image icon"></i><span class=" text_green"> <?php echo $val['Job']['time_duration']; ?> </span>

                            </div>
                            <div class="location pull-right">
                                <i><img alt="Projcet image icon" src="<?php echo $this->webroot; ?>img/project_img.png"></i><span class=" text_green">Posted by:<?php echo $postedBy['User']['first_name'] . '  ' . $postedBy['User']['last_name']; ?></span>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
    <?php }
                ...
                <div class="col-md-12 col-sm-8 marg_btm30">
                    ...
                    <div class="bg_white freelaners marg_btm30">
                        <div class="green">
                            Results<span class="date pull-right"><i class="mrg_r5"><img alt="Detail image icon" src="<?php echo $this->webroot; ?>img/deatil.png"></i></span>
                            <div class="clearfix"></div>   </div>
                        <div class="col-md-10 colsm-10 marg_tb15">
                            <p style="color: red; text-align: center;"> <strong>Sorry,</strong>No record found related to <strong><?php echo $Category['Category']['name']; ?></strong> category</p>      
                        </div>
                        <div class="clearfix"></div>
                        <div class="clearfix"></div>
                    </div>
