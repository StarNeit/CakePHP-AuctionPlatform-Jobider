<div class="container">
    <div class="title">
        <h2><span class=" text-left"><?php echo ucfirst($SkillName['Subskill']['skill_name']) . '   Developers & Programmers'; ?></span>
    ...
    <div class="col-md-7 col-md-offset-3">
        <?php echo $this->Form->create('User', array('url' => array('controller' => 'findfreelancer', 'action' => 'Skill_Freelancer/' . $id))); ?>
        <div class="input-group">
            ...
            <span class="input-group-btn btn_img">
                <button type="submit" class="btn btn-default searchbtn"><img alt="Search image" src="<?php echo $this->webroot; ?>img/search.png">
                </button>
            </span>
        </div>
        <!-- /input-group -->
            ...
            foreach ($Freelancer_user as $key => $val) {
                ...
                <div class="col-md-12 skill_sec">
                    ...
                    <div class="col-sm-6 col-md-8 middle_dv">
                        ...
                        <div class="lesval">
                            <p><?php echo substr($val['User']['description'], 0, 200) . '....'; ?>    <a href="JavaScript:void(0);" class="more">More</a></p>
                        ...
                        <h3><img  alt="location image" src="<?php echo $this->webroot; ?>img/location1.png"><b> <?php echo $val['User']['Country_name']['Country']['name']; ?></b>&nbsp; -&nbsp; Last days&nbsp;:&nbsp; <?php if (!empty($val['User']['timeduration'])) {
       ...
       // $total=count($val['User']['Skills']);
        ...
        <?php  } ?>
                    ...
                    <div class="col-sm-3 col-md-2 right_dv">
                        <p> <b><?php if (!empty($val['User']['budget'])) {
            echo '$' . $val['User']['budget'] . '.00&nbsp;/&nbsp;hr';
        } else {
            echo 'No Budget added yet !';
        } ?></b>
                            <br>
                            <!--                            <b>1,105&nbsp;</b>hours<br>-->
                            <?php
