<div class="container">
        ...
        <div class="col-md-7 col-md-offset-3">
            <?php echo $this->Form->create('User', array('url' => array('controller' => 'home', 'action' => 'findfreelancer'))); ?>
                ...
                foreach ($Freelancer_user as $key => $val) {
                    ...
                    <div class="col-md-12 skill_sec">
                        ...
                        <div class="col-sm-6 col-md-8 middle_dv">
                            ...
                            <h3><img  alt="location image" src="<?php echo $this->webroot; ?>img/location1.png"><b> <?php echo $val['User']['Country_name']['Country']['name']; ?></b>&nbsp; -&nbsp; Last days&nbsp;:&nbsp; <?php
