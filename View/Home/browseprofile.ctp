<div class="container">
    ...
    <div class="col-md-7 col-md-offset-3">
        <?php echo $this->Form->create('User', array('url' => array('controller' => 'home', 'action' => 'browseprofile'))); ?>
        <div class="input-group">
            ...
            <span class="input-group-btn btn_img">
                <button type="button" class="btn btn-default searchbtn"><img alt="Search icon image" src="<?php echo $this->webroot; ?>img/search.png"></button>
            </span>
        </div><!-- /input-group -->
                ...
                <div class="col-md-12 skill_sec">
                    <div class="col-sm-3 col-md-2 text-center immg_sec">
                        <?php if (!empty($val['User']['image'])) { ?>
                            <img class="img-thumbnail" alt="User image login" src="<?php echo $this->webroot; ?>uploads/<?php echo $val['User']['image']; ?>"/>
                        <?php } else { ?>
                    ...
                    <div class="col-sm-6 col-md-8 middle_dv">
                        ...
                        <div class="lesval">
                            <p><?php if(!empty($val['User']['description'])) { echo substr($val['User']['description'], 0, 150) . '..........'; ?> <a href="JavaScript:void(0);" class="more" style="font-size: 15px; text-decoration: none;">More</a> <?php } else { echo '<p style="color: rgb(187, 187, 187); padding: 17px; font-size: 19px;"> No other Information about yourself added in your Profile, <br> Please Complete Your Profile !</p>' ;}?></p>   </div>
                            ...
                            <h3><img alt="Location image" src="<?php echo $this->webroot; ?>img/location1.png"><b><?php echo $val['User']['country']['Country']['name']; ?></b>&nbsp; -&nbsp; Last days&nbsp;:&nbsp; <?php
