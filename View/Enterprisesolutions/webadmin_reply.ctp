                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form">
                            ...
                            <?php } ?> 
                            <?php
                            echo $this->Form->create('Solution', array('url' => array('controller' => 'enterprisesolutions', 'action' => 'reply/', $value['Solution']['id']), 'class' => 'cmxform form-horizontal'));
                            ?>
                            <div class="form-group ">
                                <?php echo $this->Form->label('email', 'Email', array('class' => 'control-label col-lg-3')) ?>
                                <div class="col-lg-6">
                                    <?php echo $this->Form->input('email', array('value' => $value['Solution']['email'], 'class' => "form-control ", 'label' => false, 'readonly' => true)); ?>
                                </div>
                            </div>
                            <div class="form-group ">
