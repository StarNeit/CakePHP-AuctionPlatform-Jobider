...
//                                            pr($record); }die;
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $record['Paypalpayment']['transection_id']; ?></td>
                                                <td><?php echo $record['Paypalpayment']['item_name']; ?></td>
                                      <td>$<?php echo $record['Paypalpayment']['payment_amount']; ?></td>
                                                <td><?php echo date('d-M-Y',strtotime($record['Paypalpayment']['payment_date'])); ?></td>
                                                <td><a href="<?php echo $this->Html->url(array('controller'=>'payments','action'=>'view_record','prefix'=>'webadmin',$record['Paypalpayment']['id'])); ?>" class="fa fa-eye"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->Html->url(array('controller'=>'payments','action'=>'delete_record','prefix'=>'webadmin',$record['Paypalpayment']['id'])); ?>"  class="fa fa-trash-o" onclick="return confirm('Are you sure? You Want to Delete it.');" ></a></td>
                                            </tr>
                                            <?php
                                            $i++;
                                        }
