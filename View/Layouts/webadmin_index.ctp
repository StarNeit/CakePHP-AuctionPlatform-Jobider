		...
		<ul class="user-info pull-left pull-none-xsm">
			...
			<li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
					<img src="assets/images/thumb-1@2x.png" alt="Circle1" class="img-circle" width="44" />
					Art Ramadani
				</a>
...
<li class="external">
	...
	<ul class="dropdown-menu-list scroller">
		<li class="active">
			<a href="#">
				<span class="image pull-right">
					<img src="assets/images/thumb-1.png" alt="circle2" class="img-circle" />
				</span>
		...
		<li class="active">
			<a href="#">
				<span class="image pull-right">
					<img src="assets/images/thumb-2.png" alt="circle 3" class="img-circle" />
				</span>
		...
		<li>
			<a href="#">
				<span class="image pull-right">
					<img src="assets/images/thumb-3.png" alt="thumb1" class="img-circle" />
				</span>
		...
		<li>
			<a href="#">
				<span class="image pull-right">
					<img src="assets/images/thumb-4.png" alt="circle4" class="img-circle" />
				</span>
		...
		<ul class="list-inline links-list pull-right">
			...
			<!-- Language Selector -->			<li class="dropdown language-selector">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
					<img src="assets/images/flag-uk.png" alt="Flag1" />
				</a>
				
				<ul class="dropdown-menu pull-right">
					<li>
						<a href="#">
							<img src="assets/images/flag-de.png" alt="Flag2" />
							<span>Deutsch</span>
						</a>
					</li>
					<li class="active">
	...
	<div class="col-sm-9">
		...
		<div class="tile-group">
			...
			<div class="tile-left">
				...
				<div class="tile-entry">
					<img src="assets/images/sample-al.png" alt="Flag7" class="pull-right op" />
				...
				<div class="tile-entry">
					<img src="assets/images/sample-it.png" alt="Flag8" class="pull-right op" />
				...
				<div class="tile-entry">
					<img src="assets/images/sample-au.png" alt="Flag9" class="pull-right op" />
