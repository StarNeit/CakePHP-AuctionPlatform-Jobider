...
<!--          <p style="color:#757575; margin-bottom:10px; font-size:14px;"> Hello </p>-->
          <p style="color:#757575; margin-bottom:10px; font-size:14px;"><strong><?php echo $client_fname.' '.$client_lname; ?></strong> send  you a message about the job <strong><?php  echo $data;?></strong> </p>
<!--        <p style="color:#757575; margin:0px; font-size:14px;"><?php //echo $client_fname.' '.$client_lname; ?> </p>-->
    ...
    <tr>
        <td><a href="http://www.www.jobider.com/client/job_application/<?php echo $Job_id; ?>"><button type="button" style="cursor:pointer; background:#66C5BF; color:#ffffff; border:0px; font-size:16px; padding:8px 15px; border-radius:4px; margin-right:15px;"> View the job application on Jobider </button></a>
      </tr>
      <tr>
