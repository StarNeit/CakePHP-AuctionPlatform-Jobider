...
<!--          <p style="color:#757575; margin-bottom:10px; font-size:14px;"> Hello </p>-->
          <p style="color:#757575; margin-bottom:10px; font-size:14px;"><strong><?php echo $client_fname.' '.$client_lname; ?></strong> you have paid  <?php echo $Payment_status ?> payment with <strong> <?php echo '$'.$amount; ?></strong> through <?php echo $payment_type; ?> and your remaining balance is <strong><?php echo $remain_balance; ?></strong> , so you can add milestone for remaining balance. </p>
<!--        <p style="color:#757575; margin:0px; font-size:14px;"><?php //echo $client_fname.' '.$client_lname; ?> </p>-->
        <hr style="border:1px solid #EDEDED;" /></td>
    </tr>
   
<!--     <tr>
      <td><p style="text-align:justify; color:#757575; margin-bottom:10px; font-size:14px; line-height:26px;"> <?php //echo $message; ?> </p></td>
    </tr>
    <tr>
        <td><a href="http://jobider.com/client/job_application/<?php //echo $Job_id; ?>"><button type="button" style="cursor:pointer; background:#66C5BF; color:#ffffff; border:0px; font-size:16px; padding:8px 15px; border-radius:4px; margin-right:15px;"> View the job application on Jobider </button></a>
      </tr>-->
      <tr>
            <td><p style="text-align:justify; color:#757575; margin-bottom:10px; font-size:14px; line-height:26px;"> Pro Tip : You also respond by replying to this email </p></td>
    ...
    <tr style="background:#424242; padding:15px 0px; float:left;"> 
     <td> 
         <table>
     <td width="60%;"> 
         <p style="color:#ffffff; font-size:13px;"> <a href="http://www.jobider.com/client/notifications" target="_blank" style="color: #C7CBD6">Change Notification settings</a> | <a href="http://www.jobider.com/privacy" target="_blank" style="color: #C7CBD6">Privacy Policy</a> | <a href="http://www.jobider.com/contactus" target="_blank" style="color: #C7CBD6">Contact & Support </a> </p>
     </td>
