...
<!--          <p style="color:#757575; margin-bottom:10px; font-size:14px;"> Hello </p>-->
          <p style="color:#757575; margin-bottom:10px; font-size:14px;"><strong><?php echo $client_fname.' '.$client_lname; ?></strong>  Credited <strong> <?php echo '$'.$amount; ?></strong> to <strong><?php echo $user_firstname.' '.$user_lastname ?></strong> for  <?php echo $data; ?> milestone  through <?php echo $payment_type; ?> for <?php  echo $Payment_status;?> </p>
