            ...
            <tbody>
                ...
                <tr>
                    <td><p style="color:#757575; margin-bottom:10px; font-size:14px;"> Hello <?php echo ucfirst($admin['User']['first_name']).' '.ucfirst($admin['User']['last_name']); ?></p>
                        <p style="color:#757575; margin-bottom:10px; font-size:14px;">Your request for <?php echo $job_title ?> is approved by  <?php echo ucfirst($session['User']['first_name']) . ' ' . ucfirst($session['User']['last_name']); ?>.Your payment will be transfer one or two days.</br>
         </p>
