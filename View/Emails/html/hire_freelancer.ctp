...
<!--          <p style="color:#757575; margin-bottom:10px; font-size:14px;"> Hello </p>-->
          <p style="color:#757575; margin-bottom:10px; font-size:14px;"><strong><?php echo $client_fname.' '.$client_lname; ?></strong>  Hire <strong> <?php echo $user_firstname.' '.$user_lastname ?></strong> to <strong><?php  echo $data;?></strong> job  </p>
...
<!--     <tr>
    ...
    <tr>
      ...
      <tr>
            <td><p style="text-align:justify; color:#757575; margin-bottom:10px; font-size:14px; line-height:26px;"> Pro Tip : You alse respond by replying to this email </p></td>
