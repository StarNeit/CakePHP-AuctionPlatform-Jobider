            ...
            <tbody>
                ...
                <tr>
                    <td><p style="color:#757575; margin-bottom:10px; font-size:14px;"> Hello <?php echo ucfirst($admin['User']['first_name']).' '.ucfirst($admin['User']['last_name']); ?></p>
                        <p style="color:#757575; margin-bottom:10px; font-size:14px;"> <?php echo ucfirst($session['User']['first_name']) . ' ' . ucfirst($session['User']['last_name']); ?> requested you to withdraw earning.</br>
             Please login with your credentials and visit the link.    
             <a href="http://www.jobider.com/">Click Here</a></p>
