...
<!--          <p style="color:#757575; margin-bottom:10px; font-size:14px;"> Hello </p>-->
          <p style="color:#757575; margin-bottom:10px; font-size:14px;">Hello, </p>
        <p style="color:#757575; margin:0px; font-size:14px;">Greetings Of The Day. </p>
        <hr style="border:1px solid #EDEDED;" /></td>
    </tr>
   
     <tr>
      <td><p style="text-align:justify; color:#757575; margin-bottom:10px; font-size:14px; line-height:26px;"> Thanks for Joining us . In order to confirm your registration with us. Please go through the link </p></td>
    </tr>
    <tr>
