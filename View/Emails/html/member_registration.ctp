...
<!--          <p style="color:#757575; margin-bottom:10px; font-size:14px;"> Hello </p>-->
     ...
     <tr>
      <td><p style="text-align:justify; color:#757575; margin-bottom:10px; font-size:14px; line-height:26px;"> <?php echo $company['User']['company']; ?> company has added you 
                                            as a Team Member.<br/>Please login with these credentials.   <br/>
                                        Email :- <?php echo $userdata['User']['email']; ?>
                                        <br/>
                                        Password :- <?php echo $password; ?></p></td>
    </tr>
    <tr>
        <td><a href="<?php echo "http://www.jobider.com/";  ?>"><button type="button" style="cursor:pointer; background:#66C5BF; color:#ffffff; border:0px; font-size:16px; padding:8px 15px; border-radius:4px; margin-right:15px;"> Click here  </button></a> <span> to login</span>
      </tr>
