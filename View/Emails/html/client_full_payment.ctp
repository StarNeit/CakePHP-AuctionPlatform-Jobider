...
<!--        <p style="color:#757575; margin:0px; font-size:14px;"> </p>-->
     ...
     <tr>
      <td>
          ...
          <p style="text-align:justify; color:#757575; margin-bottom:10px; font-size:14px; line-height:26px;"> <?php echo $client_fname.' '.$client_lname; ?> just sent payment of <?php  echo '$'.$amount;?> for a <?php echo $data; ?> completion. We have advice you to check your <?php echo $payment_type;?> account for the same. </p>
          <?php } else { ?>
          <p style="text-align:justify; color:#757575; margin-bottom:10px; font-size:14px; line-height:26px;"> <?php echo $client_fname.' '.$client_lname; ?> credited <?php  echo '$'.$amount;?> for <?php echo $data; ?> job through <?php  echo $payment_type;?> for <?php echo $Payment_status?>.  </p>
          <?php } ?> 
