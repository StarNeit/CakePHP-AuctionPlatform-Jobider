    ...
    <body>
        <table cellspacing="0px" cellpadding="10px" style="margin:0px auto; width:600;  font-family: 'Open Sans',sans-serif; border:1px solid #cccccc;">
            <tbody>
                ...
                <tr>
                    <td><p style="color:#757575; margin-bottom:10px; font-size:14px;"> Hi </p>
                        <p style="color:#757575; margin-bottom:10px; font-size:14px;">  Your request for <?php echo $job_title; ?> is rejected by <?php echo ucfirst($session['User']['first_name']) . ' ' . ucfirst($session['User']['last_name']); ?>. We wish you good luck next time.</br>
         </p>
