    ...
    <body>
        <table cellspacing="0px" cellpadding="10px" style="margin:0px auto; width:600;  font-family: 'Open Sans',sans-serif; border:1px solid #cccccc;">
            <tbody>
                ...
                <tr>
                    <td><p style="color:#757575; margin-bottom:10px; font-size:14px;"> Hello <?php echo $Client_FirstName.' '.$Client_LastName; ?></p>
                        <p style="color:#757575; margin-bottom:10px; font-size:14px;">  would like to inform you that I have applied for your  job  <strong> <?php echo $data; ?> </strong> Please Share some Basic Details regarding <strong> <?php echo $data; ?> </strong> job.  </p>
                    ...
                    <td style="width:100%;"> 
                        <table style="width:100%;">
                            ...
                            <td width="40%"><p style="text-align:right;"> <a href="https://dribbble.com/Jobider" style="text-decoration:none;"> <img alt="dribble" src="http://www.jobider.com/img/driible.png" /> </a> 
                                    ...
                                    <a href="https://www.facebook.com/pages/Jobider/839942349415993" style="text-decoration:none;"> <img alt="facebook" src="http://www.jobider.com/img/fb.png" /> </a>
                                </p> 
                            </td>
                        </table>
                    </td>
