        ...
        <div class="col-md-3 pad_l0 col-sm-3">
            ...
            <div class="panel panel-default green_bg1">
                ...
                <div class="panel-body bg_grey1 padd_tb15">
                    <p>Available now :<?php if (!empty($Payment_earning)) {
...
<?php ///echo $this->Form->end();  ?>
                    ...
                    <p><i><img src="<?php echo $this->webroot; ?>img/view.png" class="mrg_r5" alt="view earning icon image"/></i><a href="<?php echo $this->webroot; ?>freelancer/viewearning" style="text-decoration:none;"/>View pending earnings >></a></p>
...
<?php if (isset($Contect_data) and !empty($Contect_data)) { ?>
                        <table class="table cust_table11 table-striped">
                            ...
                            <tbody>
                                    <?php
                                    foreach ($Contect_data as $kk => $vv) {
                                        ?>
                                    <tr>
                                        <td><a href="<?php echo $this->webroot; ?>freelancer/job_application/<?php echo $vv['Job']['id']; ?>" style="text-decoration:none;"><?php echo $vv['Job']['job_title']; ?></a></td>
        ...
        <?php } ?>
                    ...
                    <?php } else { ?>
                        <div class="table-responsive">
                            <p class="act"> No Active Application(s) Found ! </p>
                        </div>
<?php } ?>
