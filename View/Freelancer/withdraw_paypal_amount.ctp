...
<div class="container">
    <div class="row marg_tb15">
        <div class="col-md-3 pad_l0 col-sm-3">
            ...
            <div class="panel panel-default green_bg1">
                ...
                <div class="panel-body bg_grey1 padd_tb15">
                    <p>Available now : $<?php  if(!empty($Result)){ echo $Result['Paypalpayment']['payment_amount']; }else{ echo $Credit_result['Creditpayment']['amount']; }?> </p>
        ...
        <div class="col-md-9 col-sm-9  pad_r0 ">
            <div class="bg_white">
                <div class="green"> Withdraw Earnings
                    <span class="pull-right">Total Funds : $<?php echo $Result['Paypalpayment']['payment_amount'];?></span> </div>
                <?php
                    ...
                    <div class="col-sm-9">
                        <div class="radio">
                            <label class="font_14 opensans grayclr">
                                                  <input  type='hidden' name='date[Withdrawpayment][available_balance]' value='<?php echo $Result['Paypalpayment']['payment_amount']; ?>' />
                                Available Balance<?php echo '($' . $Result['Paypalpayment']['payment_amount'] . ')'; ?></label>
                            <input class="total_amount" type="hidden" value="<?php echo $Result['Paypalpayment']['payment_amount']; ?>" />
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row"> 
                    <div class="col-sm-9 col-md-offset-3">
                        <input type="hidden" value="<?php echo $Result['Paypalpayment']['id'];?>" class="milestone_id" />
        ...
        <?php }else{?>
            ...
            <div class="bg_white">
                <div class="green"> Withdraw Earnings
                    <span class="pull-right">Total Funds : $<?php echo $Credit_result['Creditpayment']['amount'];?></span> </div>
                <?php
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <div class="radio">
                            <label class="font_14 opensans grayclr">
                                                  <input  type='hidden' name='date[Withdrawpayment][available_balance]' value='<?php echo $Credit_result['Creditpayment']['amount']; ?>' />
                                Available Balance<?php echo '($' . $Credit_result['Creditpayment']['amount'] . ')'; ?></label>
                            <input class="total_amount" type="hidden" value="<?php echo $Credit_result['Creditpayment']['amount']; ?>" />
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row"> 
                    <div class="col-sm-9 col-md-offset-3">
                        <input type="hidden" value="<?php echo $Credit_result['Creditpayment']['id'];?>" class="milestone_id" />
                        <button class="btn btn-green opensans font_14 withdraw" type="button">  Withdraw           </button>
                        <button class="btn btn-green opensans font_14" type="button" style="margin-left: 10px;">Cancel</button>
                    </div>
                </div>
