                                ...
                                <tbody>
                                    ...
                                    if (!empty($Plandata)) {
                                        ...
                                        foreach ($Plandata as $record) {
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo ucfirst($record['freelancer']['User']['first_name']).'  '.  ucfirst($record['freelancer']['User']['last_name']); ?></td>
                                                <?php if($record['Membershipplan']['membership_type']=='premium_smallAgency')  {?>
                                                <td><?php echo ' Your current plan is Premium for Small Agency'; ?></td>
                                                <?php } else{ ?>
                                                <td><?php  echo 'Freelancer Basic';?></td>
                                                <?php } ?>
                                                <td><?php echo $record['Membershipplan']['connects']; ?></td>
                                                <?php if($record['Membershipplan']['membership_type']=='premium_smallAgency'){ ?>
                                                <td><?php  echo '70'; ?></td>
                                                <?php } ?>
